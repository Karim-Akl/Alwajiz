...
const Hero = () => {
  ...
  useEffect(() => {
    const startCount = 0;
    const endCountRecruitment = 9;
    const endCountRental = 7;
    const duration = 3000;
  ...
  return (
    <section className="hero-class-bg">
      <div className="hero-class">
        <div className="flex img-text-hero">
          ...
          <div className="text">
            <p>تعرف علينا أكثر</p>
            <h3>من نحن</h3>
            <p>شركة الوجيز للاستقدام وباقات التاجير شركة مساهمة مقفلة تاسست في عام 2017م 
            لاستقدام العمالة المنزلية في جميع انحاء المملكة بترخيص رقم 380354474 وقد بدأت بتقديم خدمة الوساطة لاستقدام العمالة
          ...
          <div className="l1-hero">
            <div>
              <img
                ...
                alt="Vision"
                style={{
                  background: "hsl(204deg 12.66% 30.98%)",
            ...
            <h2>رؤيتنا</h2>
            <p>
            نسعي في شركتنا شركة الوجيز للاستقدام وباقات التاجير لان نكون الشريك الاستراتيجي المفضل لتوفير كافة الكوادر البشرية ذات الكفاءة العالية في المملكة العربية السعودية
            </p>
            <hr className="l3-hr" />
          </div>
      ...
      <div className="class-bg">
        <div style={{ width: "80%", margin: "auto", gap: "0px" }}>
          ...
          <div className="flex">
            ...
            <div
              className="l1-class-bg"
              style={{ height: "25rem", gap: "2rem" }}
            >
              <p>
              توفر شركة شركة الوجيز للإستقدام وباقات التأجير  نقل الخدمات للعملاء لجميع الجنسيات المتوفرة والشروط المطلوبة
              </p>
              <h2> نقل خدمات</h2>
              <img
      ...
      <div className="flex line-5-bg">
        ...
        <div>
          <p>
            نسعى في شركة شركة الوجيز للإستقدام وباقات التأجير  لأن نكون الشريك الاستراتيجي المفضل لتوفير
