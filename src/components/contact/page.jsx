    ...
    <section className="contact-us">
      <div className="bg-contact">
        <div className="bg-2">
          ...
          <div>
            <div
              className="flex bg-class-contact"
            ...
            >
              ...
              <div>
                ...
                <p style={{ marginBlock: "30px", width: "300px" }}>
                  <a href="https://maps.app.goo.gl/cYCd8E6zyvWCyiG98?g_st=iw">
                    ابوبكر الصديق، حي النهضة، بريدة 52388، المملكة العربية
                    السعودية
                  </a>
                </p>
                ...
                <div className="card">
                  ...
                  <a href="https://x.com/alwajez1">X</a>
                  <a href="https://x.com/alwajez1">
                    <svg
                  ...
                  <a href="https://wa.me/966920031122">
                    <svg className="socialSvg" viewBox="0 0 16 16">
